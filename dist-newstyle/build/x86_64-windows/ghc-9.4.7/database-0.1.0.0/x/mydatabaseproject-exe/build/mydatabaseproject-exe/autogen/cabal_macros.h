...
#ifndef VERSION_database
#define VERSION_database "0.1.0.0"
#endif /* VERSION_database */
#ifndef MIN_VERSION_database
#define MIN_VERSION_database(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_database */
...
#define CURRENT_COMPONENT_ID "database-0.1.0.0-inplace-mydatabaseproject-exe"
